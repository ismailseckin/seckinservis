...
output_file = r"c:\Users\USER\.gemini\antigravity\scratch\seckin-servis\assets\logos\logos.js"
...
for key, brain_file in mapping.items():
    ...
    if os.path.exists(full_path):
        ...
        with open(full_path, "rb") as f:
            ...
            js_content += f"  '{key}': 'data:{mime};base64,{b64}',\n"
    else:
